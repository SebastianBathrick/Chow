# ChowEngine
**Path:** `..\src\Chow\ChowEngine.cs`

**Description:** A static class that provides a public API to evaluate Chow source code using the interpreter. ChowEngine is home to the **interpreter pipeline** that handles lexical analysis, syntax analysis, semantic analysis, bytecode compilation, and bytecode execution.
