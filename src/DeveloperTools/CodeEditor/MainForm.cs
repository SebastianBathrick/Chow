...
namespace CodeEditor
{
    public partial class MainForm : Form
    {
        ...
        async void executeToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        void inputTextArea_TextChanged(object? sender, EventArgs e)
        {
        ...
        void logLevelComboBox_SelectedIndexChanged(object? sender, EventArgs e)
        {
            UpdateGuiState();
        }
        ...
        void copyOutputToolStripMenuItem_Click(object? sender, EventArgs e)
        {
        ...
        void copyInputToolStripMenuItem_Click(object? sender, EventArgs e)
        {
        ...
        void clearOutputToolStripMenuItem_Click(object? sender, EventArgs e)
        {
            ClearOutput();
        }
        ...
        void clearInputToolStripMenuItem_Click(object? sender, EventArgs e)
        {
            inputTextArea.Clear();
            UpdateGuiState();
        }
        ...
        void zoomComboBox_Click(object sender, EventArgs e)
        {
