...
namespace Chow.Objects
{
    ...
    public readonly struct SourceValue
    {
        ...
        internal SourceValue CreateSum(SourceValue rightOperand)
        {
            switch (LookupBinary(ExpressionOperator.Add, rightOperand))
            {
                case ConversionCase.ToInt:
                {
                    return new SourceValue(PromoteToLong() + rightOperand.PromoteToLong());
                }
                case ConversionCase.ToFloat:
                {
                    return new SourceValue(PromoteToDouble() + rightOperand.PromoteToDouble());
                }
                case ConversionCase.Nothing:
                {
                    if (_dataType == DataType.List && rightOperand._dataType == DataType.List)
                    {
                        return new SourceValue(SourceList.Concat(AsType<SourceList>(), rightOperand.AsType<SourceList>()));
                    }

                    if (_dataType == DataType.Str && rightOperand._dataType == DataType.Str)
                    {
                        return new SourceValue(AsType<string>() + rightOperand.AsType<string>());
                    }
        ...
        internal SourceValue CreateDifference(SourceValue rightOperand)
        {
        ...
        internal SourceValue CreateProduct(SourceValue rightOperand)
        {
            switch (LookupBinary(ExpressionOperator.Multiply, rightOperand))
            {
                ...
                case ConversionCase.Nothing:
                {
                    ...
                    {
                        return new SourceValue(SourceList.Repeat(AsType<SourceList>(), rightOperand.AsType<int>()));
                    }

                    if (IsIntegerTag(_dataType) && rightOperand._dataType == DataType.List)
                    {
                        return new SourceValue(SourceList.Repeat(rightOperand.AsType<SourceList>(), AsType<int>()));
                    }

                    if (_dataType == DataType.Str && IsIntegerTag(rightOperand._dataType))
                    {
                        return new SourceValue(RepeatString(AsType<string>(), rightOperand.AsType<int>()));
                    }

                    if (IsIntegerTag(_dataType) && rightOperand._dataType == DataType.Str)
                    {
                        return new SourceValue(RepeatString(rightOperand.AsType<string>(), AsType<int>()));
                    }
        ...
        internal SourceValue CreateQuotient(SourceValue rightOperand)
        {
            ...
            switch (LookupBinary(ExpressionOperator.Divide, rightOperand))
            {
                case ConversionCase.ToFloat:
                {
                    ...
                    return divisor == 0.0 
                        ...
                        : new SourceValue(PromoteToDouble() / divisor);
        ...
        internal SourceValue CreateModulus(SourceValue rightOperand)
        {
            ...
            switch (LookupBinary(ExpressionOperator.Modulus, rightOperand))
            {
                case ConversionCase.ToInt:
                {
                    ...
                    return new SourceValue((a % b + b) % b);
                }
                case ConversionCase.ToFloat:
                {
                    ...
                    return new SourceValue((l % r + r) % r);
                }
            }
        ...
        internal SourceValue CreateFloorQuotient(SourceValue rightOperand)
        {
            ...
            switch (LookupBinary(ExpressionOperator.FloorDivide, rightOperand))
            {
                ...
                case ConversionCase.ToFloat:
                {
                    ...
                    return new SourceValue(Math.Floor(PromoteToDouble() / divisor));
                }
            }
        ...
        internal SourceValue CreatePower(SourceValue rightOperand)
        {
            ...
            switch (conv)
            {
                case ConversionCase.ToInt:
                {
                    ...
                    return new SourceValue(IntPow(PromoteToLong(), rightOperand.PromoteToLong()));
                }
                case ConversionCase.ToFloat:
                {
                    return new SourceValue(Math.Pow(PromoteToDouble(), rightOperand.PromoteToDouble()));
                }
            }
        ...
        internal SourceValue CreateNegation()
        {
            switch (LookupUnary(ExpressionOperator.Negate))
            {
                case ConversionCase.ToInt:
                {
                    return new SourceValue(-PromoteToLong());
                }
                case ConversionCase.ToFloat:
                {
                    return new SourceValue(-PromoteToDouble());
                }
            }
        ...
        internal SourceValue CreateLogicalNot()
        {
