namespace Chow.Tokens
{
    ...
    interface ITokenStream
    {
        ...
        /// This stream is readonly because a
        ...
        /// </summary>
        /// <param name="expectedType1">
        /// The token type the first consumed token's type will be
        /// compared to.
        /// </param>
        /// <param name="expectedType2">
        /// The token type the second consumed token's type will be
        /// compared to.
        /// </param>
        /// <param name="expectedTypes">
        /// The token types any further consumed tokens' types will be
        /// compared to, in order.
        /// </param>
        /// <returns>The token selected after all expected tokens are consumed.</returns>
        /// <exception cref="SyntaxException">
        /// An exception containing the first expected token type
        /// that did not match and the line of the token it was compared to.
        /// </exception>
        ...
        /// </param>
        /// <returns>
        /// <c>true</c> if the selected token is <paramref name="targetType"/>;
        /// <c>false</c> if it is not or the end of this stream has been reached.
        /// </returns>
        ...
        /// The token types the selected token's type will be compared
        /// to.
        /// </param>
        /// <returns>
        /// <c>true</c> if the selected token is any of <paramref name="targetTypes"/>;
        /// <c>false</c> if it is none of them or the end of this stream has been reached.
        /// </returns>
        ...
        /// </summary>
        /// <param name="targetType">
        /// The token type the next token's type will be compared
        /// to.
        /// </param>
        /// <returns>
        /// <c>true</c> if the token after the selected token is
        ...
        /// </param>
        /// <param name="token">
        /// The consumed token, or <c>default</c> if no token was
        /// consumed.
        /// </param>
        /// <returns><c>true</c> if a token was consumed; otherwise, <c>false</c>.</returns>
