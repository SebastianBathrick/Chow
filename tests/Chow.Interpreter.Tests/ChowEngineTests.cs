namespace Chow.Interpreter.Tests
{
    ...
    public class ChowEngineTests
    {
        ...
        // --- Negative-operand arithmetic (parenthesized so the statement parses) ---
        ...
        // --- F-strings (exercise CoerceToStr conversion) ---
        ...
        // --- Subscript / indexing (scalar results only) ---
        ...
        // --- Nesting: shallow & redundant parentheses ---
